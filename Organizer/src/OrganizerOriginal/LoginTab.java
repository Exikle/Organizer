...
public class LoginTab extends JFrame implements ActionListener{
  JLabel lblUser = new JLabel("User Name:"), lblPass = new JLabel("Password:"), lblLogin = new JLabel("LOGIN");
  JLabel lblUser2 = new JLabel("User Name:"), lblPass2 = new JLabel("Password:"), lblReg = new JLabel("REGISTER");
  JPasswordField  txtPass = new JPasswordField("Password"), txtPass2 = new JPasswordField ("Password");
  JComboBox user = new JComboBox();
  JButton btnLogin = new JButton("LOGIN"), btnReg = new JButton("Register");
  JTextField txtUser = new JTextField("Enter Username");
  String usrnme="", psswrd="";
  String[] username,password;  
  int indexcount =0, counter=0;
  Color c1 = new Color(70,122,255), c2 = new Color(255,0,0), c3 = new Color(0,255,0);
  Font f1;
  ...
  public void actionPerformed(ActionEvent e){
    if (e.getSource()==user){
      ...
      for (int x=0;x<indexcount;x++){
        if ((usrnme.equals(username[x]))&&(psswrd.equals(password[x]))){
  ...
  public void register(){
    ...
    try{
      ...
      out=new PrintWriter(new BufferedWriter(new FileWriter(new File("h:LoginInfo.txt"), true)),true); 
