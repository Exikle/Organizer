...
public class NotesTab extends JFrame implements ActionListener{
  ...
  JButton btnNew=new JButton("New"), btnSave=new JButton("Save");
...
//        System.out.println(fileSelected);
  ...
  public void getFile(){
    ...
    String theTitle="",theText=""; // individual field variables 
...
//      System.out.println("Problem Closing "+e);
  ...
  public void saveFile(){
    ...
    try
    {
      ...
      out=new PrintWriter(new BufferedWriter(new FileWriter(new File("c:"+fileSelected+".txt"), false)),true); 
